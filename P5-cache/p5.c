...
void printUsage() {
  ...
  printf("  -n|n_cores <n>                  How many cores to simulate\n");
  ...
  printf("\nExamples:\n");
  printf("  shell>  ./p5 -t hmmer.2k.txt -cache 9 5 1 \n");
  printf("  shell>  ./p5 -t hmmer.2k.txt -cache 12 6 2 \n");
  printf("  shell>  ./p5 -t hmmer.2k.txt -cache 16 4 2 \n");
  printf("  shell>  ./p5 -t hmmer.1M.txt -cache 16 4 2 -limit 500\n");
  printf(
